    ...
    <div>
      <section className="bg-ink py-20 sm:py-24">
        <div className="container-luxe max-w-3xl text-center">
          ...
          <p className="mt-6 leading-relaxed text-white/65">
            The right property. The right location. The right strategy. This is the philosophy
            behind every recommendation Chacadom makes — published openly, because an informed
            client is a better client.
          </p>
        </div>
      </section>
        ...
        <div className="container-luxe">
          ...
          <div className="mt-12 grid gap-6 grid-cols-1 md:grid-cols-3">
            {[
              {
                title: 'Patience',
                text: 'Great opportunities belong to those who wait wisely. Property is a five-to-ten-year instrument — the compounding happens in the years you hold, not the month you buy. We help clients buy assets worth holding.',
              },
              {
                title: 'Positioning',
                text: 'The right location today creates tomorrow’s value. Infrastructure drives value faster than hype — bypasses, expressways, industrial parks, SEZs, airports, universities and tourism zones are the real price-makers.',
              },
              {
                title: 'Timing',
                text: 'Enter early, stay ahead, and let time build your wealth. Growth corridors sell at entry prices only once. The goal is to buy the corridor before the ribbon-cutting, not after the headlines.',
              },
            ].map((p, i) => (
              <motion.div
                key={p.title}
      ...
      <section className="section-pad bg-cream">
        <div className="container-luxe">
          <motion.div {...fadeUp} className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="heading-display mt-3 text-3xl sm:text-4xl">
              Six rules from the Chacadom desk
            </h2>
          </motion.div>
      ...
      <section className="section-pad bg-white">
        <div className="container-luxe grid gap-8 grid-cols-1 sm:grid-cols-2">
          <motion.div
            {...fadeUp}
            className="overflow-hidden rounded-2xl shadow-card ring-1 ring-gold-100"
          >
            <picture>
          ...
          >
            <picture>
              ...
              <img
                ...
                alt="Real estate rewards: patience, positioning, timing"
                width={1024}
                height={1536}
                loading="lazy"
                className="w-full"
        ...
        <div className="container-luxe text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-white/60">
              From a first plot to a diversified portfolio, the discipline is the same — and it
