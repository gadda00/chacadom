      ...
      <section className="relative overflow-hidden bg-ink py-20 sm:py-28">
        ...
        <div className="container-luxe relative max-w-3xl text-center">
          ...
          <p className="mt-6 leading-relaxed text-white/65">
            Chacadom builds more than portfolios — we build platforms. Our ventures take the house
            discipline of verification and honest math and scale it to the whole market.
          </p>
        </div>
      </section>
          ...
          <motion.div {...fadeUp} className="order-1 lg:order-2">
            <div className="inline-flex items-center gap-2 rounded-full border border-gold-300 bg-gold-50 px-4 py-1.5">
              ...
              <span className="text-xs font-bold uppercase tracking-wide2 text-gold-700">
                Flagship venture · Live now — launched 2026
              </span>
            </div>
            ...
            <p className="mt-5 leading-relaxed text-ink-soft">
              ...
              cross-agency trust layer — a platform that helps people discover, evaluate, buy, sell,
              rent and manage property across multiple agencies and developers, not just one.
            </p>
            <p className="mt-4 leading-relaxed text-ink-soft">
              Its core insight is Chacadom’s own: a market scarred by fraud doesn’t need more
              listings, it needs trust infrastructure. Keja verifies titles, scores agents, catches
              duplicate listings and flags price anomalies — then publishes the fraud it catches,
              openly.
            </p>
            ...
            {[
              {
                ...
                text: 'Property search, recommendations and qualification in English, Kiswahili and French — warm, professional, never pushy.',
              },
              {
                icon: ShieldCheck,
                title: 'Cross-agency trust scores',
                text: 'Title checks, photo authenticity, duplicate detection, pricing anomalies and agent reputation — on every listing.',
              },
              {
                icon: Calculator,
                title: 'Investment intelligence',
                text: 'Gross & net yields, ROI, payback and 5/10-year projections — with facts, estimates and assumptions labelled.',
              },
              {
                icon: MessageCircle,
              ...
              },
              {
                ...
                text: 'Property & location analysis, risks, strengths, comparables and a plain-language investment verdict.',
              },
              {
                icon: Lock,
        ...
        <div className="container-luxe relative grid items-center gap-12 lg:grid-cols-2">
          <motion.div {...fadeUp}>
            <div className="inline-flex items-center gap-2 rounded-full border border-gold-400/40 bg-white/5 px-4 py-1.5">
              ...
              <span className="text-xs font-bold uppercase tracking-wide2 text-gold-300">
                New venture capability · Keja Tokenize
              </span>
            </div>
            <h2 className="mt-4 font-display text-3xl font-bold leading-tight text-white sm:text-4xl">
              Fractional ownership of Kenyan real estate,{' '}
              <span className="gold-text">from $100</span>
            </h2>
            <p className="mt-5 leading-relaxed text-white/65">
              Chacadom is building real-estate tokenization into Keja.ai: institutional-grade
              property placed in a dedicated SPV, converted into digital tokens on a blockchain, and
              offered to KYC-verified investors — a $10M building becomes 1,000,000 tokens at $10
              each. Rental income is distributed monthly or quarterly, pro-rata, with every payout
              recorded on-chain.
            </p>
            <ul className="mt-6 space-y-3.5">
              {[
                {
                  icon: Coins,
                  text: 'Fractional entry — participate in prime assets without $100K minimums',
                },
                {
                  icon: Scale,
                  text: 'SPV legal wrappers, Ardhisasa-verified titles, independent valuations',
                },
                {
                  icon: Link2,
                  text: 'On-chain ownership record — auditable, immutable, transparent',
                },
                {
                  icon: ShieldCheck,
                  text: 'KYC/AML-gated investing, structured with Kenya’s CMA sandbox in mind',
                },
              ].map((f) => (
          ...
          <motion.div {...fadeUp} className="relative">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-gold-400/20 shadow-gold-lg">
              ...
              <div className="absolute inset-x-6 bottom-6">
                <p className="text-[10px] font-bold uppercase tracking-wide2 text-gold-300">
                  Simulated demo portfolio
                </p>
                <p className="mt-1 font-display text-2xl font-bold text-white">
                  $45.5M+ simulated · 7.3% blended target yield
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={t}
                      className="rounded-full border border-gold-400/40 bg-ink/60 px-3 py-1 text-[11px] font-semibold text-gold-200 backdrop-blur"
                    >
                      {t}
                    </span>
                  ))}
            ...
            <div className="absolute -top-5 -right-2 rounded-2xl border border-gold-400/30 bg-ink/90 p-4 shadow-gold-md backdrop-blur sm:-right-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-bold uppercase tracking-wide text-gold-300">
                    Entry minimum
                  </p>
            ...
            {[
              {
                ...
                text: 'The consumer platform is live; this phase builds the institutional layer around it — legal/IP structure, token classification, data model and regulatory engagement, plus the first SPV pilots for tokenization.',
              },
              {
                phase: '2027',
                window: 'H1–H2',
                title: 'KEJA AI Platform & Portal hardening',
                text: 'Property intelligence and developer portal; wallet beta, KJAI utility design, compliance stack and audits.',
              },
              {
                phase: '2028',
                window: 'H1–H2',
                title: 'Controlled Token Launch',
                text: 'Controlled KJAI ecosystem launch subject to approvals; first KPT property pilot and asset servicing.',
              },
              {
                phase: '2029',
                window: 'Scale',
                title: 'Scale & East Africa',
                text: 'Scale tokenized products and expand across East African markets — Uganda, Tanzania, Rwanda.',
              },
              {
                phase: '2030',
                window: 'Pan-African',
                title: 'Institutional Infrastructure',
                text: 'Pan-African network and institutional infrastructure — banks, funds and enterprise clients on KEJA DATA.',
              },
              {
                phase: 'North Star',
                window: 'The principle',
                title: 'Intelligence First',
                text: 'Build intelligence first; prove value second; marketplace and recurring revenue third; regulated financial infrastructure only when legally, economically and operationally defensible.',
              },
            ].map((p, i) => (
              <motion.div
                key={p.phase}
                ...
                className="rounded-2xl border border-white/10 bg-white/5 p-7 backdrop-blur transition hover:border-gold-400/40"
              >
                <div className="flex items-center justify-between">
                  <p className="text-xs font-bold uppercase tracking-wide2 text-gold-400">
                    {p.phase}
                  </p>
              ...
              <div className="mt-5 space-y-3">
                {[
                  ...
                  [
                    'Series A',
                    'KSh 300M–1B+',
                    'East Africa, enterprise sales, tokenization infrastructure',
                  ],
                  ...
                  >
                    ...
                    <p className="shrink-0 font-display text-sm font-bold text-gold-700">
                      {target}
                    </p>
                  </div>
                ))}
                ...
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    <div key={w} className="flex items-start gap-3">
                      <span className="mt-0.5 rounded-full bg-gold-gradient px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-white">
                        {w}
                      </span>
        ...
        <div className="container-luxe text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-ink-muted">
              Agencies and developers can join the Keja network; investors can work directly with
              the Chacadom desk. Either way, the discipline is the same.
            </p>
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link to="/contact" className="btn-gold">
                Start a conversation <ArrowRight className="h-4 w-4" />
              </Link>
              <a href={SITE.kejaUrl} target="_blank" rel="noreferrer" className="btn-outline">
                Explore keja.ai
              </a>
            </div>
          </motion.div>
