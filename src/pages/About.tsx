      ...
      <section className="bg-ink py-20 sm:py-24">
        <div className="container-luxe max-w-3xl text-center">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold leading-tight text-white sm:text-5xl">
            We don’t sell property. We help people make{' '}
            <span className="gold-text">better property decisions.</span>
          </h1>
          <p className="mt-6 leading-relaxed text-white/65">
            Chacadom Investments is a Kenyan real-estate investment house built on one conviction:
            this market rewards discipline and punishes shortcuts. Everything we do — advisory,
            sales, leasing, development, management — starts with verified facts and honest math.
          </p>
        </div>
      </section>
        ...
        <div className="container-luxe grid items-center gap-12 lg:grid-cols-2">
          <motion.div {...fadeUp}>
            ...
            <div className="mt-6 space-y-4 leading-relaxed text-ink-soft">
              <p>
                Chacadom began with land — the asset class where Kenya’s wealth is most visibly
                created, and most quietly lost. We watched families buy plots with clean savings and
                dirty titles, and decided the market deserved better: an investment house where
                verification comes before marketing, and the client’s outcome comes before the
                commission.
              </p>
              <p>
                From land, we grew into the full chain: investment advisory, commercial sales and
                leasing, joint ventures, marketing and portfolio management. In 2026 we launched our
                digital flagship, Keja.ai — taking our verification discipline to the entire market
                through AI.
              </p>
              <p>
                What hasn’t changed is the house rule: we say no to deals we wouldn’t do with our
                own money. That’s not a slogan; it’s a filter. It’s why our clients come back, and
                why they send their families.
              </p>
            </div>
          </motion.div>
            ...
            <div className="space-y-10">
              {TIMELINE.map((t, i) => (
                ...
                >
                  ...
                  <div
                    className={`pl-12 sm:pl-0 ${i % 2 === 1 ? 'sm:order-1 sm:pr-12 sm:text-right' : 'sm:pl-12'}`}
                  >
            ...
            {[
              {
                icon: ShieldCheck,
                title: 'Trust',
                text: 'Verification before marketing. We publish our checks, label our assumptions, and put the client’s outcome ahead of the commission.',
              },
              {
                icon: Handshake,
                title: 'Integrity',
                text: 'The deal we’d accept for our own families — or we say no. Our reputation compounds; a single shortcut spends it.',
              },
              {
                icon: Gauge,
                title: 'Performance',
                text: 'Yields, occupancy, appreciation — measured and reported. “It felt like a good deal” is not a performance metric.',
              },
              {
                icon: Users,
                title: 'Partnership',
                text: 'We build with clients, landowners and developers for the long term. The best transactions are the ones that repeat.',
              },
            ].map((v, i) => (
              <motion.div
                key={v.title}
          ...
          {[
            {
              icon: Target,
              title: 'Mission',
              text: 'Turn property information into intelligent investment decisions, and qualified prospects into confident real-estate clients.',
            },
            {
              icon: Eye,
              title: 'Vision',
              text: 'East Africa’s most trusted real-estate investment house — the standard for verified, disciplined, client-first property transactions.',
            },
            {
              icon: Compass,
              title: 'Approach',
              text: 'Facts before opinions. Math before marketing. Patience before pressure. And technology — Keja.ai — everywhere it helps.',
            },
          ].map((m) => (
